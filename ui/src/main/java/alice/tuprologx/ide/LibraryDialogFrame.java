    ...
    private void displayLibraryPanel()
    {
        ...
        addLibraryPanelLayout.setHorizontalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, addLibraryPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(addLibraryPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(addLibraryPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                        .addComponent(add)
