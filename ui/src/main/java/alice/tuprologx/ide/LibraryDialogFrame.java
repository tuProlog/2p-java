...
public class LibraryDialogFrame extends GenericFrame implements LibraryListener {
    ...
    private void displayLibraryPanel() {
        ...
        GroupLayout addLibraryPanelLayout = new GroupLayout(addLibraryPanel);
        addLibraryPanel.setLayout(addLibraryPanelLayout);
        addLibraryPanelLayout.setHorizontalGroup(
                addLibraryPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                     .addGroup(GroupLayout.Alignment.TRAILING, addLibraryPanelLayout.createSequentialGroup()
                                                                                                    .addContainerGap()
                                                                                                    .addGroup(addLibraryPanelLayout
                                                                                                                      .createParallelGroup(GroupLayout.Alignment.LEADING)
                                                                                                                      .addGroup(addLibraryPanelLayout
                                                                                                                                        .createParallelGroup(GroupLayout.Alignment.TRAILING)
                                                                                                                                        .addComponent(add)
                                                                                                                                        .addComponent(libraryClassnameField, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE))
        ...
        addLibraryPanelLayout.setVerticalGroup(
                addLibraryPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                     .addGroup(addLibraryPanelLayout.createSequentialGroup()
                                                                    .addContainerGap()
                                                                    .addGroup(addLibraryPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                                                                   .addComponent(libraryFullNameLabel)
                                                                                                   .addComponent(libraryFileLabel))
                                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                    .addGroup(addLibraryPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                                                                   .addComponent(libraryClassnameField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                                                                   .addComponent(browseButton))
                                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                    .addComponent(add)
    ...
    public void setLibraryManagerStatus() {
        ...
        for (int i = 0; i < rows; i++) {
            ...
            try {
                ...
                if (((JComboBox<String>) librariesDisplayPanel.getComponent(3 * i + 2)).getSelectedItem()
                                                                                       .equals("Loaded")) {
                    if (libraryManager.isExternalLibrary(libraryClassname)) {
                        try {
    ...
    /**
     * @see LibraryListener#libraryLoaded(LibraryEvent)
     */
    public void libraryLoaded(LibraryEvent event) {
        ...
        if (!libraryManager.contains(libraryName)) {
            try {
                alice.tuprolog.interfaces.ILibraryManager mainLibraryManager = libraryManager.getEngine()
                                                                                             .getLibraryManager();
    ...
    /**
     * @see LibraryListener#libraryUnloaded(LibraryEvent)
     */
