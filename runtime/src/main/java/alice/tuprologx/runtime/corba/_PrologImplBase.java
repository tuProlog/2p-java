...
public abstract class _PrologImplBase extends org.omg.CORBA.portable.ObjectImpl
                implements Prolog, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("clearTheory", new Integer (0));
    _methods.put ("getTheory", new Integer (1));
    _methods.put ("setTheory", new Integer (2));
    _methods.put ("solve", new Integer (3));
    _methods.put ("hasOpenAlternatives", new Integer (4));
    _methods.put ("solveNext", new Integer (5));
    _methods.put ("solveHalt", new Integer (6));
    _methods.put ("solveEnd", new Integer (7));
    _methods.put ("loadLibrary", new Integer (8));
    _methods.put ("unloadLibrary", new Integer (9));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // org/alice/tuprologx/runtime/corba/Prolog/solve
       {
         ...
         SolveInfo __result = null;
         __result = this.solve (g);
         out = rh.createReply();
         SolveInfoHelper.write (out, __result);
         break;
       }
