...
public class ThreadLibraryTestCase {
    ...
    public void testThread_send_msg_2() throws MalformedGoalException, NoSolutionException, InvalidTheoryException {
        ...
        Term X = sinfo.getVarValue("X");
        assertEquals(Struct.atom("messaggio molto importante"), X);
        ...
        assertEquals(Struct.atom("messaggio molto importante"), X1);
    }
    ...
    public void testThread_get_msg_2() throws InvalidTheoryException, MalformedGoalException, NoSolutionException {
        theory =
                "start(X) :- msg_queue_create('CODA'), thread_create(ID, thread1(X)), thread_sleep(500), invio('CODA', 'messaggio molto importante'), lettura(ID,X).\n" +
    ...
    public void testMutex_destroy_1() throws InvalidTheoryException, MalformedGoalException {
        theory =
                "start(M, X) :- mutex_create(M), mutex_lock(M), thread_create(ID, thread1(M)), thread_sleep(500), message_queue_create('CODA'), invio('CODA', 'messaggio molto importante'), lettura(ID, X). \n" +
    ...
    public void testMutex_lock_unlock_1() throws InvalidTheoryException, MalformedGoalException {
        theory =
                "start(X) :- mutex_lock('mutex'), thread_create(ID, thread1(X)), msg_queue_create('CODA'), invio('CODA', 'messaggio molto importante'), lettura(ID,X). \n" +
    ...
    public void testMutex_trylock_1() throws InvalidTheoryException, MalformedGoalException {
        theory =
                "start(X) :- mutex_lock('mutex'), thread_create(ID, thread1(X)), message_queue_create('CODA'), invio('CODA', 'messaggio molto importante'), lettura(ID,X). \n" +
    ...
    public void concurrentTest3() throws InvalidTheoryException, MalformedGoalException, NoSolutionException {
        theory =
                "study(L_stud, L_exams, N,Num) :- thread_create(ID, loop(1, N, 1, L_stud, L_exams)), length(L_exams,Num). \n" +
