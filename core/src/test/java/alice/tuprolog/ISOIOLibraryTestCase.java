...
//                      + File.separator + "binFile.bin";
    ...
    public void test_open() throws MalformedGoalException, InvalidTheoryException {
        ...
        info = engine.solve(
                "open('" + writePath.replace(".txt", ".myext") + "','write',X,[alias('editor'), type(text)]).");
    ...
    public void test_3() throws InvalidTheoryException, MalformedGoalException, IOException {
        ...
        String theory = "test3:- " +
                        "open('" + readPath +
                        "','write',X,[alias(ciao, computer, casa, auto),type(text),eof_action(reset),reposition(true)])," +
                        "open('" + writePath +
                        "','write',Y,[alias(telefono, rosa),type(text),eof_action(reset),reposition(true)])," +
    ...
    public void test_4() throws InvalidTheoryException, MalformedGoalException, IOException {
        ...
        String theory = "test4:-" +
                        "open('" + writePath +
                        "','write',Y,[alias(telefono, casa),type(text),eof_action(reset),reposition(true)])," +
    ...
    public void test_5() throws InvalidTheoryException, MalformedGoalException, IOException {
        ...
        theory = "test5:-" +
                 "open('" + readPath +
                 "','read',X,[alias(reading, nome),type(text),eof_action(reset),reposition(true)])," +
                 "read_term(X,I,[])," +
                 "write('user_output', I)," +
                 "close('reading').";
        engine.setTheory(new Theory(theory));
    ...
    public void test_8() throws InvalidTheoryException, MalformedGoalException, IOException {
        ...
        theory = "test8:-" +
                 "open('" + binPath +
                 "','read',X,[alias(readCode, nome),type(binary),eof_action(reset),reposition(true)])," +
                 "peek_byte('nome', PB)," +
                 "write(PB)," +
                 "close(X).";
        engine.setTheory(new Theory(theory));
    ...
    public void test_9() throws InvalidTheoryException, MalformedGoalException, IOException {
        ...
        theory = "test9:-" +
                 "open('" + binPath +
                 "','write',X,[alias(readCode, nome),type(binary),eof_action(reset),reposition(true)])," +
