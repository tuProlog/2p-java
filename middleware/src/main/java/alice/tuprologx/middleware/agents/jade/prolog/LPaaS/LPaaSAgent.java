...
import alice.tuprologx.middleware.agents.jade.prolog.ContainerAgent;
...
public final class LPaaSAgent extends ContainerAgent {
	...
	protected void setup() {
	    ...
	    if(security == null || !security.equals("yes")) {
	    	...
	    	behaviour.setEngine(getMainEngine());
			behaviour.setComponentConfiguratorId(getComponentConfiguratorId());
	    	...
	    	secureBehaviour.setEngine(getMainEngine());
	    	secureBehaviour.setComponentConfiguratorId(getComponentConfiguratorId());
